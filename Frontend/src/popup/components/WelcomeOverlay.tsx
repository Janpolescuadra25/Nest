...
export default function WelcomeOverlay({ user, jwt, onDismiss }: WelcomeOverlayProps) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="mb-4">
          <div className="text-emerald-600 font-bold text-sm uppercase tracking-wide">Solyra</div>
          <h1 className="mt-3 text-2xl font-semibold text-gray-900">Welcome to Solyra!</h1>
