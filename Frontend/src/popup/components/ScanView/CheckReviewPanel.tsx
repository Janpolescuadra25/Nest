  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-3 space-y-3">
      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-[1.5fr_120px] gap-2 text-xs text-gray-600 font-medium">
          <div>Description</div>
          <div>Amount</div>
        </div>
        {editData.lineItems.map((item, index) => (
          <div key={index} className="grid grid-cols-[1.5fr_120px] gap-2 text-gray-900">
            <input
              type="text"
